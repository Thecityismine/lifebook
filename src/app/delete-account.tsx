...
const styles = StyleSheet.create({
  ...
  warningCard: { flexDirection: 'row', alignItems: 'flex-start', gap: Spacing.md, padding: Spacing.xl, borderRadius: Radius.lg, backgroundColor: AppColors.blushSoft, borderWidth: 1, borderColor: '#F4C8D3' }, warningCopy: { flex: 1 }, warningTitle: { color: AppColors.danger, fontSize: 16, fontWeight: '800', marginBottom: 5 }, transferNote: { flexDirection: 'row', alignItems: 'flex-start', gap: Spacing.md, marginTop: Spacing.lg, padding: Spacing.lg, borderRadius: Radius.md, backgroundColor: AppColors.sunSoft }, form: { gap: Spacing.xl, marginTop: Spacing.xxl },
  errorBox: { flexDirection: 'row', gap: Spacing.sm, marginTop: Spacing.lg, padding: Spacing.lg, borderRadius: Radius.md, backgroundColor: AppColors.blushSoft }, errorText: { flex: 1, color: AppColors.danger, fontSize: 13, lineHeight: 19 }, deleteButton: { minHeight: 56, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: Spacing.sm, marginTop: Spacing.xl, borderRadius: Radius.lg, backgroundColor: AppColors.danger }, deleteText: { color: AppColors.paper, fontSize: 15, fontWeight: '800' }, disabled: { opacity: 0.42 }, pressed: { opacity: 0.75, transform: [{ scale: 0.99 }] },
