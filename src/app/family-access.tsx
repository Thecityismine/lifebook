...
const styles = StyleSheet.create({
  ...
  hero: { flexDirection: 'row', gap: Spacing.lg, padding: Spacing.xl, borderRadius: Radius.xl, backgroundColor: AppColors.hero, ...Shadow.card }, heroIcon: { width: 56, height: 56, alignItems: 'center', justifyContent: 'center', borderRadius: Radius.lg, backgroundColor: AppColors.paper }, heroCopy: { flex: 1 }, heroTitle: { color: AppColors.onDark, fontSize: 18, fontWeight: '800' }, heroText: { color: '#C9D0E0', fontSize: 13, lineHeight: 20, marginTop: 5 },
  ...
  memberActions: { flexDirection: 'row', flexWrap: 'wrap', gap: Spacing.sm, marginLeft: 58 }, actionButton: { minHeight: 38, justifyContent: 'center', paddingHorizontal: Spacing.md, borderRadius: Radius.full, borderWidth: 1, borderColor: AppColors.line }, confirmButton: { backgroundColor: AppColors.blushSoft, borderColor: AppColors.blush }, actionLabel: { color: AppColors.violet, fontSize: 11, fontWeight: '800' }, removeLabel: { color: AppColors.danger },
  transferCard: { gap: Spacing.lg, padding: Spacing.xl, borderRadius: Radius.lg, backgroundColor: AppColors.sunSoft, borderWidth: 1, borderColor: AppColors.sun }, transferHeading: { flexDirection: 'row', gap: Spacing.md }, transferTitle: { color: AppColors.ink, fontSize: 16, fontWeight: '800' }, cancelButton: { minHeight: 42, alignItems: 'center', justifyContent: 'center' }, cancelText: { color: AppColors.inkMuted, fontSize: 13, fontWeight: '800' },
