...
const styles = StyleSheet.create({
  ...
  hero: { flexDirection: 'row', gap: Spacing.lg, padding: Spacing.xl, borderRadius: Radius.xl, backgroundColor: AppColors.hero, ...Shadow.card }, heroIcon: { width: 58, height: 58, alignItems: 'center', justifyContent: 'center', borderRadius: Radius.lg, backgroundColor: AppColors.paper }, heroCopy: { flex: 1 }, heroTitle: { color: AppColors.onDark, fontSize: 18, fontWeight: '800' }, heroText: { color: '#C9D0E0', fontSize: 13, lineHeight: 20, marginTop: 5 },
  ...
  linkCard: { flexDirection: 'row', alignItems: 'center', gap: Spacing.md, minHeight: 82, padding: Spacing.lg, borderRadius: Radius.lg, backgroundColor: AppColors.paper, borderWidth: 1, borderColor: AppColors.border }, dangerCard: { flexDirection: 'row', alignItems: 'center', gap: Spacing.md, minHeight: 82, padding: Spacing.lg, borderRadius: Radius.lg, backgroundColor: AppColors.blushSoft, borderWidth: 1, borderColor: AppColors.blush }, linkIcon: { width: 46, height: 46, alignItems: 'center', justifyContent: 'center', borderRadius: Radius.md, backgroundColor: AppColors.violetSoft }, dangerIcon: { width: 46, height: 46, alignItems: 'center', justifyContent: 'center', borderRadius: Radius.md, backgroundColor: AppColors.paper }, linkCopy: { flex: 1 }, linkTitle: { color: AppColors.ink, fontSize: 15, fontWeight: '800' }, dangerTitle: { color: AppColors.danger, fontSize: 15, fontWeight: '800' }, linkDetail: { color: AppColors.inkMuted, fontSize: 12, lineHeight: 18, marginTop: 3 },
