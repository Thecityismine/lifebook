      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <View style={styles.headerActions}>
            ...
            <Pressable accessibilityLabel="Add a reminder" onPress={() => router.push('/edit-reminder')} style={styles.addIcon}><Ionicons name="add" size={26} color={AppColors.onAccent} /></Pressable>
          </View>
        </View>
